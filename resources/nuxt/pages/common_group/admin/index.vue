<template>
  <div class="list">
    ...
    <div class="management-tablewrap">
      ...
      <data-destroy
        props-model-url="/api/common_group/admin/"
...
<script>
import CommonGroupProfile from '~/components/dialogs/common_group/admin/CommonGroupProfile'
...
export default {
  ...
  data() {
    return {
      ...
      // テーブルヘッダ
      headers: [
        { text: '共有グループ', align: 'center', value: 'name' },
  ...
  methods: {
    ...
    async indexDatas(search = null) {
      ...
      try {
        const res = await this.$axios.get('/api/common_group/admin', {
          params: options
        })
