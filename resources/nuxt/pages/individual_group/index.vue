<template>
  <div class="list">
    ...
    <div class="management-tablewrap">
      ...
      <data-destroy
        props-model-url="/api/individual_group/"
      ...
      <data-enable-disable
        props-model-url="/api/individual_group/"
        props-model-name="IndividualGroup"
...
<script>
import IndividualGroupProfile from '~/components/dialogs/individual_group/IndividualGroupProfile'
...
export default {
  ...
  data() {
    return {
      ...
      // テーブルヘッダ
      headers: [
        { text: '個別グループ', align: 'center', value: 'name' },
